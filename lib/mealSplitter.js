const receiptImport = require('../receipt.js');

/**
 * Split bills
 * @param {Object} receipt The filled out receipt
 * @returns {Object} The split data
 */
function mealSplitter(receipt = receiptImport) {
    const { appetizers = [], peopleSplittingAppetizers = [], meals, tax, tip, subtotal, total } = receipt;
    ...
    const result = {
        ...
        appetizersTotal: appetizersTotal.toFixed(2),
        peopleTotals
    };
